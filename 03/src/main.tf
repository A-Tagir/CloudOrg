...
resource "yandex_compute_instance_group" "lamp-1" {
  ...
  instance_template {
    ...
    metadata = {
      ...
      user-data = <<-EOT
        #!/bin/bash
        #echo '<html><body><img src="https://storage.yandexcloud.net/${yandex_storage_bucket.netology-bucket.bucket}/${yandex_storage_object.image.key}"></body></html>' > /var/www/html/index.html
        echo '<html><body><img src="https://storage.yandexcloud.net/tagir-neto-bucket/netology.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=YCAJEyp8rM2Fzmo_wJUuMbxB7%2F20250627%2Fru-central1%2Fs3%2Faws4_request&X-Amz-Date=20250627T152935Z&X-Amz-Expires=2592000&X-Amz-Signature=3f1dea206ef1afc297e623acdaab8f44520a57a45576b0c338c9c16e11590627&X-Amz-SignedHeaders=host"></body></html>' > /var/www/html/index.html
  ...
  depends_on = [
    yandex_resourcemanager_folder_iam_binding.network-user
  ]
